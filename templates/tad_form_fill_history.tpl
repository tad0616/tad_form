        ...
        <{foreach from=$history_fill item=history}>
            <tr>
                ...
                <td class="text-right text-end">
                    ...
                    <a href="<{$xoops_url}>/modules/tad_form/index.php?op=tad_form_fill_create&ofsn=<{$history.ofsn}>&ssn=<{$history.ssn}>&code=<{$history.code}>" class="btn btn-sm btn-warning"><{$smarty.const._TAD_EDIT}></a>
                </td>
            </tr>
        <{/foreach}>
        </table>
