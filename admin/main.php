...
function list_tad_form_main()
{
    ...
    while (false !== ($all = $xoopsDB->fetchArray($result))) {
        ...
        $enable_tool = ('1' == $enable) ? "<a href='main.php?op=set_form_status&ofsn=$ofsn&enable=0'><img src='../images/$pic' align='absmiddle' hspace=6 alt='" . _MA_TADFORM_COL_ENABLE . "' title='" . _MA_TADFORM_COL_ENABLE . "'></a>" : "<a href='main.php?op=set_form_status&ofsn=$ofsn&enable=1'><img src='../images/$pic' align='absmiddle' hspace=6 alt='" . _MA_TADFORM_COL_ACTIVE . "' title='" . _MA_TADFORM_COL_ACTIVE . "'></a>";
        $multi_sign_pic = ('1' == $multi_sign) ? "<img src='../images/report_check.png' align='absmiddle' hspace=6 alt='" . _MA_TADFORM_MULTI_SIGN . "' title='" . _MA_TADFORM_MULTI_SIGN . "'>" : '';
        $show_result_pic = ('1' == $show_result) ? "<img src='../images/report.png' align='absmiddle' hspace=6 alt='" . _MA_TADFORM_SHOW_RESULT . "' title='" . _MA_TADFORM_SHOW_RESULT . "'>" : '';
