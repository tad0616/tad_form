...
function tad_form_col_form($the_ofsn="",$csn="",$mode=""){
	...
	$xoopsTpl->assign( 'kind_text' , chk($kind,"text","1","selected"));
	$xoopsTpl->assign( 'kind_radio' , chk($kind,"radio","0","selected"));
	$xoopsTpl->assign( 'kind_checkbox' , chk($kind,"checkbox","0","selected"));
	$xoopsTpl->assign( 'kind_select' , chk($kind,"select","0","selected"));
	$xoopsTpl->assign( 'kind_textarea' , chk($kind,"textarea","0","selected"));
	$xoopsTpl->assign( 'kind_fck' , chk($kind,"fck","0","selected"));
	$xoopsTpl->assign( 'kind_show' , chk($kind,"show","0","selected"));
	$xoopsTpl->assign( 'chk1' , chk($chk,"1"));
	$xoopsTpl->assign( 'chk0' , chk($chk,"0","1"));
	$xoopsTpl->assign( 'func_none' , chk($func,"","1","selected"));
	$xoopsTpl->assign( 'func_sum' ,chk($func,"sum","0","selected"));
	$xoopsTpl->assign( 'func_avg' , chk($func,"avg","0","selected"));
	$xoopsTpl->assign( 'func_count' , chk($func,"count","0","selected"));
	$xoopsTpl->assign( 'public1' , chk($public,"1"));
	$xoopsTpl->assign( 'public0' , chk($public,"0","1"));
}
