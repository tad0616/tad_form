...
function list_tad_form_main()
{
    ...
    while ($data = $xoopsDB->fetchArray($result)) {
        ...
        $multi_sign_pic = ($multi_sign == '1') ? "<img src='" . XOOPS_URL . "/modules/tad_form/images/report_check.png' align='absmiddle' hspace=6 alt='" . _MD_TADFORM_MULTI_SIGN . "' title='" . _MD_TADFORM_MULTI_SIGN . "'><span class='badge badge-success'>" . _MD_TADFORM_MULTI_SIGN . "</span> " : "";
