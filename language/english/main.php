...
define("_MD_TADFORM_EMPTY","There are currently no forms can be filled!");
...
define("_MD_TADFORM_TXTUNLOCK","Unlocked : form can be submited");
define("_MD_TADFORM_CAPTCHA_ERROR","Did not pass validation, can not be saved.");
define("_MD_TADFORM_SAVE_OK","You have completed!");
...
define("_MD_TADFORM_HIDE_RESULT","The result does not public.");
?>
